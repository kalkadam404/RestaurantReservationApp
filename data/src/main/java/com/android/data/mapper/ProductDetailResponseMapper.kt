...
val ProductDetailResponseMapper: (ProductDetailsResponse) -> Product = { response ->
    Product(
        id = response.id,
...
val localProductDetailResponseMapper: (ProductEntity) -> Product = { response ->
    Product(
        id = response.id,
...
val productDetailToProductDetailEntityMapper: (Product) -> ProductEntity = { product ->
    ProductEntity(
        id = product.id,
